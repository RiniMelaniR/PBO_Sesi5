...
public class Tugas1 {
  public static void main(String[] args) {
    String[] boxOfUnorganizedFruits = {"Apel","Pisang","Anggur","Jambu","Pepaya","Duku","Durian","Jeruk","Mangga","Manggis",};
    ...
    System.out.println("hasil dari pengelompokan buah,agar petani mudah : "+ Arrays.deepToString(boxesOfOrganizedFruits));
  }
